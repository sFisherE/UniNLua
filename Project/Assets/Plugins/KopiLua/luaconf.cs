...
//#endif
		...
		*/
		...
		public static int setvbuf(Stream stream, CharPtr buffer, int mode, uint size)
		{
            ...
            Unity3DIntegration.Assert(false,"setvbuf not implemented yet - mjf");
			return 0;
		}
		...
		public static int GetUnmanagedSize(Type t)
		{
            ...
            Unity3DIntegration.Assert(false,"Trying to get unknown sized of unmanaged type " + t.ToString());
			return 0;
		}
	}
}
