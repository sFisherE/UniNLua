	...
	public partial class Lua
	{
		...
		*/
		public class CallInfo : ArrayElement
		{
			...
			public void SetArray(object array)
			{
                ...
                Unity3DIntegration.Assert(this.values != null);
			}
			...
			public static int operator -(CallInfo ci, CallInfo[] values)
			{
                ...
                Unity3DIntegration.Assert(ci.values == values);
				return ci.index;
			}
			...
			public static int operator -(CallInfo ci1, CallInfo ci2)
			{
                ...
                Unity3DIntegration.Assert(ci1.values == ci2.values);
		...
		*/
		public static LuaState tostate(object l)
		{
            ...
            Unity3DIntegration.Assert(LUAI_EXTRASPACE == 0, "LUAI_EXTRASPACE not supported");
			return (LuaState)l;
		}
